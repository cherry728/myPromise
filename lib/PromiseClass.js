...
/**
 *  Promise.resolve(..)会接受任何thenable，而且将它展开直至非thenable值。
 *  但你会从Promise.resolve(..)那里得到一个真正的，纯粹的Promise，一个你可以信任的东西。
 *  如果你传入的东西已经是一个纯粹的Promise了，那么你会单纯地将它拿回来：
 * 
 *  1. 如果你传递一个纯粹的Promise给Promise.resolve(..)，你会得到这个完全相同的promise
...
class Promise {
     ...
     * @param {*} promises 
     * 如果传入空数组，那么这个promise永远不会得到处理，仍然是pending状态
     */
